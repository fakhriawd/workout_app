...
class AppColor{
  ...
  static Color homePageTitle=const Color(0xFF382f51);
  ...
  static Color secondPageContainerGradient1stColor=const Color(0xff696fe8);
  static Color secondPageContainerGradient2ndColor=const Color(0xFF6588f4);
